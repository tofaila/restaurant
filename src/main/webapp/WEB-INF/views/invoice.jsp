...
<html>
    <head>
        ...
        <title>Invoice - Dhaka Restaurant</title>
        <style type="text/css">
    ...
    <jsp:include page="header.jsp"></jsp:include>
                                ...
                                <tr ng-repeat="c in citems">
                                    <td>
                                        <img id="prodimage" alt="product image"
                                             src="resources/images/{{c.pid}}.jpg" class="img-rounded">
                                        <h4><em>{{c.pname}}</em></h4>
                                    </td>
                                    <td></td>
        ...
        <c:if test="${!bill}">
            <div class="jumbotron container h4" id="jumbotrondiv" align="center"
                ...
                <c:if test="${success}">
                    Thanks for having with us.<br>                    
                    Happy Confirming with Dhaka Restaurant<br>
                    <br>
                ...
                <c:if test="${!success}"><h3>Sorry For the inconvenience.</h3> <br>
                    Please try again later !!! Continue Choosing until then<br>
                    <br>
                    <br>
                    <a href="buyproductpage" type="button" id="continuebutton"
                       class="btn"><span class="glyphicon glyphicon-shopping-cart"></span>
