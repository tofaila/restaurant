...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            angular.module('organocartpackage', []).controller('PaymentController',
                    function ($scope) {
                        $scope.paymentangularobject = paymentlist;
                        $scope.custinfo = customerinfolist;
                        $scope.custorder = customerorderlist;
                        console.log($scope.paymentangularobject);
//                        $scope.cars = {
...
//                        }
    ...
    <body id="page-top" ng-app="organocartpackage" ng-controller="PaymentController">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="newPaymentObject" action="addingpayment"
                                       enctype="multipart/form-data">

                                
                                    <div class="form-group">
                                        <form:input class="form-control" Placeholder="Payment Id"
                                                    type="text" path="payid" readonly="false" required="true"></form:input>
                                        </div>
                               
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Payment Date" type="text" path="paydate" required="true" id="paydate"></form:input>
                                            <label for="paydate">Payment Date</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="Amount" path="amount" required="true" id="amount"></form:input>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-label-group">
                                                <form:input type="text" class="form-control" Placeholder="Payment Type" path="paytype" required="true" id="paytype"></form:input>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            <form:select path="custid" cssClass="form-control" required="true" id="custid">
                                                <option value="">-- Choose Customer --</option>
                                                <form:option ng-repeat="c in custinfo" value="{{c.custid}}">
                                                    {{c.fullname}}
                                                </form:option>
                                            </form:select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control" ng-model="orderid" ng-options="x.orderid as x.orderid for x in custorder" required="true">
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:hidden  class="form-control" value="{{orderid}}" path="orderid"></form:hidden>
                                        </div>
                                    ...
                                    <c:if test="${check}">
                                        <form:button id="editbuttons" type="submit" name="Addingpayment" class="btn btn-success">Add Details</form:button>
                                        <form:button id="removebuttons" type="reset" class="btn btn-danger">Reset Details</form:button>
                                       
                                    </c:if>
                                    <c:if test="${!check}">
                                        <form:button id="editbuttons" type="submit" name="EditingPayment" class="btn btn-success">Edit Details</form:button>
                                        <form:button id="removebuttons" type="reset" class="btn btn-danger">Reset Details</form:button>
                                    </c:if>
                                    <a href="showpaymentpage"><button id="show" type="button" class="btn">Cancel</button></a>        
                                </form:form>
                            </div>
                            <!-- panel body end -->
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="P in paymentangularobject">
                                                ...
                                                <td><a href="editingpaymentbutton?getpayid={{P.payid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removingpayment/{{P.payid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
