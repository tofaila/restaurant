...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin - Add Customerinfo</title>
        ...
        <script>
            var sm = ${customerinfolist};
            console.log(sm);
            angular.module('myapp', []).controller('CustomerinfoController',
                    function ($scope) {
                        $scope.customerinfoAngularObject = sm;
                    });
        </script>

    </head>
    <body id="page-top" ng-app="myapp" ng-controller="CustomerinfoController">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Customerinfo</li>
                    </ol>

                    <div class="panel-body">
                        <div class="formcontainer">
                            <c:if test="${check}">
                                <form:form name="addcustomerinfoform" commandName="newCustomerinfoObject" action="addingcustomerinfo" method="post">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="Table  Id" type="text" path="custid" required="true" id="custid"></form:input>
                                                <label for="custid">Customer Id</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="Full Name" type="text" path="fullname" required="true" id="fullname"></form:input>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input type="text" class="form-control" placeholder="Gender" path="gender" required="true" id="gender"></form:input>
                                                <label for="gender">Gender</label>
                                        </div>
                                    </div>
                                    <form:button id="editbuttons" type="submit" name="Addingcustomerinfo" class="btn btn-success">Add Customerinfo</form:button>
                            ...
                            <c:if test="${!check}">
                                <form:form name="addcustomerinfoform" commandName="newCustomerinfoObject" action="addingcustomerinfo" method="post">
                                    <div class="form-group">
                                       <div class="form-label-group">
                                           <form:input class="form-control" Placeholder="Customer Id" type="text" path="custid" required="true" id="custid" readonly="true"></form:input>
                                                <label for="custid">Customer Id</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <form:button id="editbuttons" type="submit" name="EditingCustomerinfo"
                                                 class="btn btn-success">Edit Customerinfo</form:button>
                                    <form:button id="removebuttons" type="reset" class="btn btn-danger">Reset Details</form:button>
                                     <a href="showcustomerinfo"><button id="show" type="button" class="btn">Cancel</button></a> 
                                </form:form>
                            </c:if>
                        </div>
                    </div>
...
<!--                                    <tfoot>
                                    ...
                                    <tbody>
                                        <tr ng-repeat="x in customerinfoAngularObject">
                                            <td>{{x.custid}}</td>
                                            <td>{{x.fullname}}</td>
                                            ...
                                            <td>{{x.emailid}}</td>
                                            <td>{{x.gender}}</td>
                                            <td><a href="editingcustomerinfobutton?getcustid={{x.custid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removingcustomerinfo/{{x.custid}}"><button  id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
